...
// edits change Task as the input field is changed
    ...
    return(
        <div className="card">
            ...
            </div>  : <div className="task"><span className="item-title"> <ul>{props.title}</ul></span></div>}
            
            <div className="action">   
            <button value={props.id} onClick={HandleEdit} className="update-btn">
                Update
            </button> 
            <button value={props.id}  onClick={HandleDelete} className="delete-btn">
                Delete!
            </button>
            </div>
        </div>
